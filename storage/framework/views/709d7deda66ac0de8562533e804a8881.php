                                   ...
                                   <div class="cmn--media right-dropdown-icon d-flex align-items-center">
                                    ...
                                    <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img"
                                             src="<?php echo e(App\CentralLogics\Helpers::onErrorImage(auth('admin')->user()->image, asset('storage/app/public/admin') . '/' . auth('admin')->user()->image, asset('public/assets/admin/img/160x160/img1.jpg'), 'admin/')); ?>"
...
<?php /**PATH /home/infinitt/namelok.co.tz/resources/views/layouts/admin/partials/_header.blade.php ENDPATH**/ ?>