                    ...
                    <div class="card-header">
                        <h5 class="card-title d-flex align-items-center">
                            <span class="card-header-icon mb-1 mr-2">
                                <img src="<?php echo e(asset('public/assets/admin/img/bag.png')); ?>" class="w--17" alt="">
                            </span>
                            <span><?php echo e(translate('Business Information')); ?></span>
                        </h5>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo e(route('admin.business-settings.store.update-setup')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1"><?php echo e(translate('restaurant')); ?> <?php echo e(translate('name')); ?></label>
                                        <input type="text" name="restaurant_name" value="<?php echo e($name); ?>" class="form-control"
                                               placeholder="<?php echo e(translate('New Restaurant')); ?>" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="country"><?php echo e(translate('country')); ?></label>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('time_zone')); ?></label>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?php echo e($phone); ?>" name="phone" class="form-control" placeholder="" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" value="<?php echo e($email); ?>" name="email" class="form-control" placeholder="" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1"><?php echo e(translate('address')); ?></label>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('currency')); ?></label>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label"><?php echo e(translate('Currency Symbol Position')); ?></label>
                                        ...
                                        <div class="d-flex flex-wrap align-items-center form-control border">
                                            <label class="form-check form--check mr-2 mr-md-4 mb-0 change-currency-position"
                                                   data-route="<?php echo e(route('admin.business-settings.store.currency-position',['left'])); ?>">
                                            ...
                                            <label class="form-check form--check mb-0 change-currency-position"
                                                   data-route="<?php echo e(route('admin.business-settings.store.currency-position',['right'])); ?>">
                                                <input type="radio" class="form-check-input"
                                                        name="projectViewNewProjectTypeRadio"
                                                        id="projectViewNewProjectTypeRadio2" <?php echo e((isset($config) && $config=='right')?'checked':''); ?>>
                                                <span class="form-check-label">
                                                        <?php echo e(translate('Right')); ?> (<?php echo e(\App\CentralLogics\Helpers::currency_symbol()); ?>)
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('footer')); ?> <?php echo e(translate('text')); ?></label>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label class="input-label"
                                            for="exampleFormControlInput1"><?php echo e(translate('pagination')); ?></label>
                                        <input type="text" value="<?php echo e($pagination_limit); ?>"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control change-self-pickup-status"
                                               data-route="<?php echo e(route('admin.business-settings.store.self-pickup',[$status])); ?>">
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                            <span class="line--limit-1">
                                                <strong><?php echo e(translate('self_pickup')); ?></strong>
                                            </span>
                                                <span class="form-label-secondary text-danger d-flex ml-1" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('When this option is enabled the user may pick up their own order.')); ?>"><img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" name="self_pickup" class="toggle-switch-input" <?php echo e($sp == 1 ? 'checked' : ''); ?>>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control"
                                               onclick="email_verification('<?php echo e(route('admin.business-settings.store.email-verification',[$status])); ?>')">
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                            <span class="line--limit-1">
                                                <strong><?php echo e(translate('email verification')); ?></strong>
                                            </span>
                                                <span class="form-label-secondary text-danger d-flex ml-1" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If this field is active, customer have to verify their email verication through an OTP')); ?>"><img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" class="toggle-switch-input" name="email_verification" <?php echo e($ev == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control"
                                               onclick="phone_verification('<?php echo e(route('admin.business-settings.store.phone-verification',[$status])); ?>')">
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                                <span class="line--limit-1">
                                                    <strong><?php echo e(translate('phone')); ?> <?php echo e(translate('verification')); ?></strong>
                                                </span>
                                                <span class="form-label-secondary text-danger d-flex ml-1" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo e(translate('If this field is active, customer have to verify their phone number through an OTP')); ?>"><img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" class="toggle-switch-input" name="phone_verification" <?php echo e($pv == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control deliveryman-self-registration"
                                               data-route="<?php echo e(route('admin.business-settings.store.dm-self-registration',[$dm_status])); ?>">
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                            <span class="line--limit-1">
                                                <strong><?php echo e(translate('Deliverman_self_registration')); ?></strong>
                                            </span>
                                                <span class="form-label-secondary text-danger d-flex ml-1" data-toggle="tooltip" data-placement="right"
                                                      data-original-title="<?php echo e(translate('When this field is active, delivery men can register themself using the delivery man app.')); ?>">
                                                    <img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" name="dm_self_registration" class="toggle-switch-input" <?php echo e($dm_self_registration == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control guest-checkout-status"
                                               data-route="<?php echo e(route('admin.business-settings.store.guest-checkout',[$guest_checkout_status])); ?>">
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                            <span class="line--limit-1">
                                                <strong><?php echo e(translate('guest_checkout')); ?></strong>
                                            </span>
                                                <span class="form-label-secondary text-danger d-flex ml-1" data-toggle="tooltip" data-placement="right"
                                                      data-original-title="<?php echo e(translate('When this option is active, users may place orders as guests without logging in.')); ?>">
                                                    <img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" name="guest_checkout" class="toggle-switch-input" <?php echo e($guest_checkout == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label class="toggle-switch h--45px toggle-switch-sm d-flex justify-content-between border rounded px-3 py-0 form-control"
                                               onclick="partial_payment_status('<?php echo e(route('admin.business-settings.store.partial-payment',[$partial_payment_status])); ?>')">
                                            <span class="pr-1 d-flex align-items-center switch--label">
                                            <span class="line--limit-1">
                                                <strong><?php echo e(translate('partial_payment')); ?></strong>
                                            </span>
                                                <span class="form-label-secondary text-danger d-flex ml-1" data-toggle="tooltip" data-placement="right"
                                                      data-original-title="<?php echo e(translate('When this option is enabled, users may pay up to a certain amount using their wallet balance.')); ?>">
                                                    <img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="info">
                                                </span>
                                            </span>
                                            <input type="checkbox" name="partial_payment" class="toggle-switch-input" <?php echo e($partial_payment == 1 ? 'checked' : ''); ?>>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group">
                                        <label class="input-label text-capitalize"><?php echo e(translate('partial_payment_combine_with')); ?>

                                            <span class="form-label-secondary text-danger ml-1" data-toggle="tooltip" data-placement="right"
                                                  data-original-title="<?php echo e(translate('The wallet balance will be combined with the chosen payment method to complete the transaction.')); ?>">
                                                <img src="<?php echo e(asset('public/assets/admin/img/info-circle.svg')); ?>" alt="info">
                                            </span>
                                        </label>
                                        <select name="partial_payment_combine_with" class="form-control">
                                            <option value="COD" <?php echo e($combine_with=='COD'?'selected':''); ?>><?php echo e(translate('COD')); ?></option>
                                            <option value="digital" <?php echo e($combine_with=='digital'?'selected':''); ?>><?php echo e(translate('digital')); ?></option>
                                            <option value="offline" <?php echo e($combine_with=='offline'?'selected':''); ?>><?php echo e(translate('offline')); ?></option>
                                            <option value="all" <?php echo e($combine_with=='all'?'selected':''); ?>><?php echo e(translate('all')); ?></option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label><?php echo e(translate('logo')); ?></label><small class="text-danger"> ( <?php echo e(translate('ratio')); ?> 3:1 )</small>
                                ...
                                <div class="col-md-6 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label><?php echo e(translate('Fav Icon')); ?></label><small class="text-danger"> ( <?php echo e(translate('ratio')); ?> 1:1 )</small>
                                        <div class="custom-file">
                                            <input type="file" name="fav_icon" id="customFileEg2" class="custom-file-input"
                                                   accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                            <label class="custom-file-label"
                                                   for="customFileEg2"><?php echo e(translate('choose')); ?> <?php echo e(translate('file')); ?></label>
                                        </div>
                                        <div class="text-center">
                                            <img id="viewer_2" class="mt-4 border rounded p-2 aspect-1 mw-145 object-cover"
                                                 src="<?php echo e($favIcon); ?>"
                                                 alt="<?php echo e(translate('fav_icon')); ?>"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function maintenance_mode() {
            Swal.fire({
                ...
                if (result.value) {
                    $.get({
                        url: '<?php echo e(route('admin.business-settings.store.maintenance-mode')); ?>',
                        contentType: false,
                        processData: false,
                        beforeSend: function () {
                            $('#loading').show();
        ...
        $(document).ready(function () {
            $("#phone_verification_on").click(function () {
                if ($('#email_verification_on').prop("checked") == true) {
                    ...
                    const message = "<?php echo e(translate('Both Phone & Email verification can not be active at a time')); ?>";
                    toastr.info(message);
                }
            });
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infinitt/namelok.co.tz/resources/views/admin-views/business-settings/restaurant-index.blade.php ENDPATH**/ ?>